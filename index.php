...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $faculty_id = $_POST['username']; // Faculty ID
    ...
    $query = "SELECT * FROM facultydet WHERE rollno = ? AND dob = ?";
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        // If faculty_id or password doesn't match
...
<head>
    ...
    border-bottom-left-radius: 50%; /* Curve the bottom-left corner */
    background-color: #c0392b;
...
<body>
    ...
    <h2 class="mb-4 text-center text-white" style="font-size: 45px;font-family:roboto;">Faculty Login</h2>
    
    <form action="" method="POST" style="width: 80%; max-width: 400px;">
    <div class="mb-3">
        <label for="username" class="form-label text-white">Faculty ID</label>
        <input type="text" class="form-control" id="username" name="username" placeholder="Enter Faculty ID" required>
    </div>
